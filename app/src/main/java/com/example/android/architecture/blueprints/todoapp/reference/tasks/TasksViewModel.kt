...
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksAction.ActivateTaskAction
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksAction.ClearCompletedTasksAction
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksAction.CompleteTaskAction
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksAction.LoadTasksAction
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksFilterType.ACTIVE_TASKS
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksFilterType.ALL_TASKS
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksFilterType.COMPLETED_TASKS
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksResult.ActivateTaskResult
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksResult.ClearCompletedTasksResult
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksResult.CompleteTaskResult
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksResult.LoadTasksResult
import com.example.android.architecture.blueprints.todoapp.reference.tasks.TasksViewState.UiNotification.COMPLETE_TASKS_CLEARED
...
import com.example.android.architecture.blueprints.todoapp.reference.util.notOfType
